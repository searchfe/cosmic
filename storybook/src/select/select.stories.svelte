<script>
    ...
    import { Select, Checkbox } from '@cosmic/core/components';
    let value1 = 1;
    let value2 = '';
    let selectedItems = [];
    let selectedLabel = '';
...
<Template let:args id="custom">
    <Select {...args} {selectedLabel} class="w-80 h-80">
        <div
            slot="options"
            class="shadow rounded px-2 py-4 mt-0 bg-cgray-400 dark:bg-cgray-700"
