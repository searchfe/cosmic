...
<Card classes="flex px-5 py-7 {classes || ''}">
  <div class="w-32 h-32 mr-5 flex-none rounded-xl bg-black">
    temp
  </div>
  <div class="flex-auto py-1 flex flex-col justify-around text-black text-sm">
    <div>一级标题</div>
    <div class="opacity-70">FC001</div>
    <div class="opacity-70">三图模版</div>
  </div>
  <div class="absolute flex bottom-7 right-5 text-sm text-black">
