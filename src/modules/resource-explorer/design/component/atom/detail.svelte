...
<div class="mb-8">
  <Breadcrumb>
    <BreadcrumbItem>
      <img class="w-10 h-10 mr-4" slot="prefix" src="https://fe-dev.bj.bcebos.com/%E4%BE%A7%E8%BE%B9%E6%A0%8F%E5%9B%BE%E6%A0%8714*14.png" alt="SC"/>
      百度搜索
    </BreadcrumbItem>
  ...
  {#each data as cate}
    <CollapseItem headerClass="pl-0 font-normal" header={cate.name} key={cate.key} let:isSelected={active}>
      ...
      <div class="grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-10">
        <AtomMicroCard classes=""></AtomMicroCard>
        <AtomMicroCard classes=""></AtomMicroCard>
        <AtomMicroCard classes=""></AtomMicroCard>
        <AtomMicroCard classes=""></AtomMicroCard>
        <AtomMicroCard classes=""></AtomMicroCard>
