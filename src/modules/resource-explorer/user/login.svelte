...
<Layout>
  <div class="w-full h-full bg-gray-100">
    <div class="absolute flex left-1/2 top-1/2 w-890 h-418 rounded-4xl overflow-hidden transform -translate-x-1/2 -translate-y-1/2">
      ...
      <div class="h-full w-370 box-border px-40 flex flex-col justify-center bg-white">
        ...
        <div class="text-h4 mt-40 mb-20">
          ...
          <input
            ...
            name="username" id="username" type="text" placeholder="请输入账号/邮箱"
          >
        </div>
        <div class="text-h4 mb-30">
          ...
          <input
            bind:value="{password}"
            class="ml-10 box-border p-10 w-240 h-36 rounded border-gray-400 border-solid border opacity-60"
            name="password" id="password" type="password" placeholder="请输入密码"
          >
        </div>
