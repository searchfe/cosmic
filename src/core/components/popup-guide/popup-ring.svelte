...
>
  ...
  <div class="only-dark-show">
    <SVG src={require('./popup-ring-dark.svg')} width="30" height="30" />
  </div>
  <div class="only-light-show">
    <SVG src={require('./popup-ring-light.svg')} width="30" height="30" />
  </div>
</div>
<div
