<script lang="ts">
    ...
    const defaultContainerClass =
        'flex items-center h-30 inline-block z-10 min-w-28 w-auto hover:shadow shadow text-base font-normal';
...
<div class={containerComputedClass} on:click={change}>
    ...
    <span class="pl-20 float-right opacity-50">{keyConf.text}</span>
</div>
